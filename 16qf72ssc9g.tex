...
\citet{Goodfellow-et-al-2016} argue although some methods like Newton's method can resolve the conflicts imposed by Hessian matrix $\matchrt{H}$ poor conditioning, but the application of Newton's method in neural network
