...
Ill conditioning is one of the most common challenges in second-order numerical optimization. The condition number is a measurement of how sensitive the output of a model is to a small change in input. Commonly the condition number is used to measure the tolerance of a model to an input noise. \\
...
In gradient based training Ill conditioning occurs when 
