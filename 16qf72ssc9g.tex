...
\citet{Goodfellow-et-al-2016} argue although some methods like Newton's method can resolve the conflict imposed by Hessian matrix $\matchrt{H}$ poor conditioning
