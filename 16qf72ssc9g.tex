...
Much of the efforts in research have been invested in finding the trouble-free optimisation start position that leads to convergence towards global optimum and avoids complex global structure. On the other hand, minimum success has achieved in developing algorithms that can escape the trap of local features. Almost all gradient based algorithms are designed to  and 
\end{enumerate}
