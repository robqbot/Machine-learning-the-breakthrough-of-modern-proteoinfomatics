...
In high dimensional model trainings, saddle points are more commonly encounter than local extremes, where it is both a local minimum at one cross section 
\begin{equation}
