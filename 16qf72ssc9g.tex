...
Ill conditioning occurs when curvature correction term is overpowering the improvement quantity determined by gradient, which essentially means an im model training performance. 
