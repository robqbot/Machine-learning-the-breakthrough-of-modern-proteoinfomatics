...
\end{equation}
where $\mu$ is model training rate, $x_0$ is the previous evaluation point, $g$ and $\ma$ is the gradient at $x_0$ current evaluation point given by $x_0-\mu\mathcal{g}$
