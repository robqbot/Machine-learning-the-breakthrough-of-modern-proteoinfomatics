...
\end{equation}
$L^2$ regularization also commonly referred as weight decay, ridge regression or Tikhonov regularization. $\mathcal{w}$ in $L^2$ regularization can be solved algebraically 