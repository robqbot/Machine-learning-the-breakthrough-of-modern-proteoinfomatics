...
which has advantages in dealing with models that work with large absolute values, such scenario often attracts penalties even the error percentage is low
\end{enumerate}
