...
where $\mathcal{x}$ is the input vector, $y^*(\mathcal{x})$ is the actual output with given input vector $mathcal{x}$, $y(\mathcal{x})$ is the model predicted output with given input 
\par 
