...
where $\mathcal{x}$ is the input vector, $y^*(\mathcal{})$ is the actual output with given input vector $mathcal{x}$, $y(\mathcal{x})$ is the model predicted output with given $\mathcal{x}$. 
\par 
