...
The function measure the divergence between the distribution of predicted values and distribution of observed values. One advantage of cross entropy loss is fast convergence and allow quick learning process particular for sigmoid activation functions
\end{enumerate}
