...
\end{equation}
    \item Cross Entropy \\
Cross entropy is also known as log loss and is widely applicable in binary classification, which is ar popular in visual pattern recognition applications with convolutional neural network, which has the form:
\begin{equation}
