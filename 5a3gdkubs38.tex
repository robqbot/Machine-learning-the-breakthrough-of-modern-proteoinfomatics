...
Hinge Loss commonly used for max-margin classification, Hinge loss works well as a classifier in SVMs~\cite{Cortes_1995}. SVMs are supervised learning model 
\end {enumerate}
