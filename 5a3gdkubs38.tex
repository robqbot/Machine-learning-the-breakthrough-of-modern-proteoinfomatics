...
\par 
Most of the modern neural networks adopt back propagation algorithm during training, the loss function therefore has to be at least 1\textdegree differentiable to allow error gradient to be calculated. The loss function can be generalized in the form:
