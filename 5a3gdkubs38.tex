...
Hinge Loss commonly used for max-margin classification, Hinge loss works well as a training classifier in SVMs~\cite{Cortes_1995}. The intended output from SVMs $\hat{y} = \pm 1$
\end {enumerate}
