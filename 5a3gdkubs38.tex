...
KL divergence better known as relative entropy, is a probabilistic measurement on the divergence of predicted distribution to expected distribution. KL divergence can be interpreted in term of cross entropy as the difference between the entropy of training data and the co
\end {enumerate}
