...
The function measure the divergence between the distribution of predicted values and distribution of observed values. One advantage of cross entropy loss is that algorithm allfast convergence and allow quick learning process, this is particularly advantageous for neurons with sigmoid activation functions. 
    \item Other forms\\
