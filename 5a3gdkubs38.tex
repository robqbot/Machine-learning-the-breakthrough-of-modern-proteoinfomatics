...
where $\mathcal{x}$ is the input vector, $y^*(\mathcal{I})$ is the actual output with given input vector $mathcal{I}$, $y(\mathcal{x})$ is the model predicted output with given $\mathcal{x}$. 
\par 
