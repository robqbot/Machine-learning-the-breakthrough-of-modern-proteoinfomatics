...
Likehood loss is commonly used in classification models. 
    \item Cross Entropy \\
Cross entropy is also known as log loss widely applicable in binary classification, which is extremely popular in visual pattern recognition application with convolutional neural network, which has the form:
\begin{equation}
