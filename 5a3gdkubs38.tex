...
The function measure the divergence between the distribution of predicted values and distribution of observed values. One advantage of cross entropy loss is fast convergence and allow quick learning process, this is particular for sigmoid activation functions
\end{enumerate}
