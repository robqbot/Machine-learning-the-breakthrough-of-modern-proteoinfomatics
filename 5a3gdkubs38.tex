...
KL divergence better known as relative entropy, is a probabilistic measurement on the divergence of predicted distribution to expected distribution. KL divergence can be interpreted as the combination of training entropy and the cross entropy between model prediction and training data, which has the form of:
\begin{equation}
