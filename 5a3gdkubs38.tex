...
\end{equation}
    \item Cross Entropy \\
Cross entropy is also known as log loss and is widely applicable in binary classification, which is arguably the most popular in visual pattern recognition applications with convolutional neural network, which has the form:
\begin{equation}
