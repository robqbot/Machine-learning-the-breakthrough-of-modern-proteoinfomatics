...
\par 
We here discuss a few common loss functions from each classification and regression categories. Classification models are often used for predicting a discate categories, classes or labels a given input belongs to using past experience.  include:
