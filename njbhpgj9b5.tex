...
Unsupervised learnings often involve finding a close representation of a given big dataset, which preserves as much information in dataset~\textit{x} while mcu slim in size.