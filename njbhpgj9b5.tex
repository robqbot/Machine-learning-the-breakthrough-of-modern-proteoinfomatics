...
PCA is one of the most common data compression algorithm in unsupervised learnings to reduce data dimensionality. Thi where the underlie dataset is typically high in dimensions.   
