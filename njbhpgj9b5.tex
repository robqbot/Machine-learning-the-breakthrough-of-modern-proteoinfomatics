...
To generalize into classification models, we can define binary class distribution, namely zero and one. A distribution over two classes is unconventional 
