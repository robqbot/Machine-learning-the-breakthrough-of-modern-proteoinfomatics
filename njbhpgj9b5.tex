...
Kernel tricks enable the study of non-linear relationships with respect to input $\mathrm{X}$ by guarantee a convergence under convex optimization. Furthermore, kernel function $\mathcal{k}$ is computationally more efficient than taking 
