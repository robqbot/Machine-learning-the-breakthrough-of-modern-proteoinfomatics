...
To generalize into classification models, we can define binary class distribution, namely zero and one. One way to A distribution over two classes is unconventional 
