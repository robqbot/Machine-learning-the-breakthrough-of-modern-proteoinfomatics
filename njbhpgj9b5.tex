...
\par 
Despite the clustering property can be measured in average Euclidean distance within the clusters, clustering methods inherit ill posed problem, where there is hardly any quantitative criteria to measure the performance of the clustering in representing real dataset. 