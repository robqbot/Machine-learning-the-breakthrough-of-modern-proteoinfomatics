...
Another popular class of supervised learning algorithms is nearest neighbour regression. $\mathcal{k}$-nearest neighbour is arguably one of most well-known. 
