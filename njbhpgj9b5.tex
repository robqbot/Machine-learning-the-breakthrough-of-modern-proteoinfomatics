...
Unsupervised learnings often involve finding a close representation of a given  dataset, which preserves as much information in dataset~\textit{x} while much slimer in size.