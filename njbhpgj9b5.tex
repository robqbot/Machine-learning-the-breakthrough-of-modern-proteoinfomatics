...
Unsupervised learnings often involve finding a close representation of a given dataset, which preserve as much information in dataset~\textit{x} while slim