...
\par 
Despite the clustering property can be measured in average Euclidean distance to reflect the closeness between clustering and data representation, clustering methods  inherent ill posed problem, where there is hardly any quantitative criteria to measure the performance of the representation to real dataset. 