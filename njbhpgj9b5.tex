...
SVMs are driven by linear function $\mathcal{w}^T\mathcal{x}+b$. The diversity of SVMs provided by the form of kernels. Kernels are diverse and can take forms of linear, non-linear, polynomial, radial basis function and sigmoid. The 
