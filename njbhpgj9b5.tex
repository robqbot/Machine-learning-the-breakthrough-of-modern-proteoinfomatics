...
\par 
Clustering methods do possess inherent ill posed problem, where there is hardly any quantitative criteria to measure the performance of the representation to real dataset. Aver