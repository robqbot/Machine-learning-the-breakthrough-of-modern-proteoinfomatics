...
\end{equation}
where $\mathrm{X}$ is input vector, $\mathcal{y}$ is model output, $\mathcal{w}$ is the parameter matrix. If $\mathcal{y}$ expressed as Gaussian conditional distribution 
