...
Recurrent neural networks (RNNs) have connections between nodes reputation in dealing with sequential data, particular in places where data is independent to time steps. 
