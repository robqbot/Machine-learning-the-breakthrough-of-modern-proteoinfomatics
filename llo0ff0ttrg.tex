...
In addition, the local optimum trap is a far more pronounced issue with BPTT~\cite{Cu_llar}. This arguably is due to the recurrent feedback loop tends to create chaotic on the error surface, which in turn results more frequent local optimum islands 