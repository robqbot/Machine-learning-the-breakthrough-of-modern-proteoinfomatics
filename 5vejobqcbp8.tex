...
\end{equation}
where $\delta$ is a small stabilization constant with a magnitude of $10^{-7}$. $\tau_i$ is the accumulation of squared sum of previous evaluation, $\tau_0 = 0$. $\mu$ is predefined initial learning rate and $\mathcal{g}$ is the gradient of cu 
