...
AdaGrad algorithm propagates large updates for infrequent parameters and only small updates for frequent ones, which makes AdaGrad a particular suited for training models over sparse datasets. 
\end{enumerate}
