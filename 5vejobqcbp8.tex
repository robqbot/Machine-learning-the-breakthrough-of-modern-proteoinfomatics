...
Polak-Ribi\`ere method defines $\beta_{i+1}$ as:
\begin{equation}
    \beta_{i+1} = \frac {\mathcal{g}_{i+1}-\mathcal{g}_i}{\mathcal{g}_{i}^T\mathcal{g}_{i}}
\end{equation}
Another popular approach is Fletcher-Reeves method:
\begin{equation}
    \beta_{i+1} = \frac {\mathcal{g}_{i+1}^T\mathcal{g}_i}{\mathcal{g}_i^T\m
\end{equation}
\end{enumerate}