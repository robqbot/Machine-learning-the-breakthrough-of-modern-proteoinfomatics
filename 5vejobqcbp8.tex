...
\end{equation}
where $\mu$ is learning rate, a definable scaler determine . This method is commonly referred as gradient descent or method of steepest descent~\cite{Debye_1909}. 
