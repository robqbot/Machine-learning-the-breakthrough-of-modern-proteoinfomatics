...
AdaGrad algorithm allows large updates for infrequent parameters and only small updates for frequent ones, which makes is particular suited for training models over sparse datasets, 
\end{enumerate}
