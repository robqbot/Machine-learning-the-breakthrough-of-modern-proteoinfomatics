...
As a convention, the collection of all gradients (partial derivatives) at different plans is referred as Jacobian matrix $\mathcal{J}$ in machine learning, which is definedefines
\begin{equation}
