...
For a multi-dimensional input $x$, directional gradient at $\mathcal{x}$ in the direction $\mathcal{u}$ defined by $\bigtriangledown_xf(x)$ provides information of the changing direction of the 
