...
\end{equation}
Below, we will discuss several commonly used first order optimisation methods, which also forms the foundation for other combinatory approaches that seeks either better efficiency or accuracy. 
\begin{enumerate}
