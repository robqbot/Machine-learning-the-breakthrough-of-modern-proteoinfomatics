...
As a convention, the collection of all gradients (partial derivatives) for from different plans is referred as Jacobian matrix $\mathcal{J}$ in machine learning, which is defined by:
\begin{equation}
