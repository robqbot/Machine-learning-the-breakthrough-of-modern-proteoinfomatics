...
As a convention, the collection of all gradients (partial derivatives) at different plans is referred as Jacobian matrix $\mathcal{J}$ in machine learning, which is defined by:
\begin{equation}
    \mathcal{J}_{i,j} = \frac{\partial}{\partial x_j}\mathcal{Obj}(\phi)_i
\end{equation}
