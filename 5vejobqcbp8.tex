...
SGD is arguably the most popular optimization algorithm due to its easy concept, relatively low computation burden and relatively fast training speed. SGD has the advantage over gradient descent 
    \item \\
\end{enumerate}
