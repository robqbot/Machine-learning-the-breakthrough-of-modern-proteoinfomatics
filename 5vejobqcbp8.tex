...
For multi-dimensional input $\mathcal{X$ Gradient at $\mathcal{x}$ in the direction $\mathcal{u}$ defined by provides information of the changing direction of the 
