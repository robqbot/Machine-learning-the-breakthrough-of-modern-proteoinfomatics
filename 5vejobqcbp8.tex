...
SGD is arguably the most popular optimization algorithm due to its easy concept, relatively low computation burden and relatively fast training speed.  gradient descent by updating gradient on each training epoch 
    \item \\
\end{enumerate}
