...
Heavy computational burden caused by inverse Hessian matrix can be sufficiently mitigated by conjugate gradient method. In conjugate gradients algorithm, training iteration $i$ will take searching direction $\mathrm{d}$ defined as:
\begin{equation}
\end{equation 
\end{enumerate}