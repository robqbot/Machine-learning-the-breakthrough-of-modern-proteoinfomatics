...
Heavy computational burden caused by inverse Hessian matrix can be sufficiently mitigated by conjugate gradient method. In conjugate gradients algorithm, the 
\end{enumerate}