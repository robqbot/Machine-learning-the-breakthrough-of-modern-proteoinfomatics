...
Optimisation is an active developing field, new algorithms have been developed constantly.  the context of machine learning, gradient based algorithms are overwhelmingly 
