...
\end{equation}
where $\mu$ is learning rate, a definable scaler determines the step size . This method is commonly referred as gradient descent or method of steepest descent~\cite{Debye_1909}. 
