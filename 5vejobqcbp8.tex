...
Optimisation is an active developing field, new algorithms have been developed , in the context of machine learning, gradient based algorithms are overwhelmingly 
