...
For multi-dimensional input $X$, directional gradient at $\mathcal{x}$ in the direction $\mathcal{u}$ defined by $\bigtriangledown_x$ provides information of the changing direction of the 
