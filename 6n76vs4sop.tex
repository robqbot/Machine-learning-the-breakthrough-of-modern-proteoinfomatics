...
Quantile loss is another commonly used loss function, which provides a confident envelope around prediction. Quantile loss is valuable in predicting intervals rather decision making
\end{enumerate}