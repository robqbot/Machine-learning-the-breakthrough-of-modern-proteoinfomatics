...
\end{equation}
This variation however made MAE is difficult to calculate gradient and heavy on computation. Nevertheless, due to its linear representation, MAE does offer balanced penalty on outlier errors, which MSE on the other hand, can easily dominated by the heavy penalty on this region.  
    \item \\
    \item Other forms\\
