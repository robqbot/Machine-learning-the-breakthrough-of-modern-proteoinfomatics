...
\begin{equation}
    ...
    \end{array}\right.
\end{equation}
$\delta$ is Huber parameter, which The advantage of Huber loss is apparent at small error region defined by $\delta$, where Huber loss transits from absolute error to quadratic. 
