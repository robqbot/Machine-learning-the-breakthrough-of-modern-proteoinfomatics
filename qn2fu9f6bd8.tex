...
However, logistic functions plateau at either 0 or 1, which results nodes saturation around plateau and convergence gradients at both regions are approaching 0, which 
\item Softmax \\
