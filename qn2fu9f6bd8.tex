...
\item Sinusoid \\
\citet{Gashler_2014} proposed sinusoidal activation function enabled artificial neural network to study time series dataset and have found great efficiency of sinusoidal activated neural in extracting  with   
\end{enumerate}