...
\par 
Softplus function is also referred as SmoothReLU function, which is another variation of RELU. As name suggested, softplus smooth out the ab which adopts the form of   
