...
where $a_{i}$ represents leakage parameter, which is generally small and trainable for each node (neuron). Nonetheless, the consistent benefits of P need further investigation. 
