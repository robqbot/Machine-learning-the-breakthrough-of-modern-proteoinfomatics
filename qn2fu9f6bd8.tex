...
Sigmoid function is often characterised by its sigmoid curve, which is bounded by a pair of horizontal asymptotes as $x$ reaches infinity. As an activate function, sigmoid function  it often take the forms either logistic function 
\begin{equation}
    g(x) = \frac{1} {1+ e^{-x}}
\end{equation}
