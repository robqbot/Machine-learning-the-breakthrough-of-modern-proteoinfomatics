...
The activation functions are critical for ANN models to simulate the transformation from input layer to output layer, which is generally non-linear in nature. 