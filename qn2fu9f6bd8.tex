...
\item Sinusoid \\
\citet{Gashler_2014} proposed sinusoidal activation function enabled artificial neural network to study time series dataset. Sinusoidal activation function is simply a sine function as shown below, nevertheless it seems  efficiency of sinusoidal activated neural in feature extrapolation. 
\end{enumerate}