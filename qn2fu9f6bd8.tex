...
\par 
Softplus function is also referred as SmoothReLU function, which is another variation of RELU. As name suggested, softplus smooth out the approximation of RELU from negative to positive range, this smooth effect is particular noti boundary $x=0$ which adopts the form of   
