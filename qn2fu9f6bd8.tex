...
\item Sinusoid \\
\citet{Gashler_2014} proposed sinusoidal activation function enabled artificial neural network to study time series dataset. Sinusoidal activation function is simply a sine function as shown below, nevertheless sinusoidal activated neural network seems efficient in extrapolating features from Fourier series data frame~\cite{Gashler_2014}, which may have superior advantages when 
