...
Although each neuron within a network can have individual preference of activation mode and adapts different activation functions, it is extremely rare in practise to have a mixed neuron in the same network due to 