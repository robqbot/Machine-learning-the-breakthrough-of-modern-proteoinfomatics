...
\item Softmax \\
Softmax returns a probability vector, which sums to 1. This property is applicable in transforming logits scores into probability. Softmax also referred as normalized exponential function~\cite{Howard_2007}
\item Maxout \\
\end{enumerate}