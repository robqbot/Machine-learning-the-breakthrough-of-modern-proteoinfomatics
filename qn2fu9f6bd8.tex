...
The activation functions are critical component of ANN models, which simulate the transformation from input layer to output layer, that is generally non-linear in nature~\cite{LeCun_2015}. Various studies have deProper selection of activation functions for a given scenario can lead to improved feature extraction. 