...
$O_i = g( \sum_{j} W_{bj}(\sum_{i} W_{ij} * I_i)_j$
where $I_i$ represents the input nodes, $W_{ai}$ is the weight of each input node $I_i$ in representing hidden node $H_a$, $W_{bj}$ is the weight of each hidden node $H_a$ 