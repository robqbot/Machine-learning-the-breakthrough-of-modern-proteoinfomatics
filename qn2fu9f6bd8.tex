...
The activation functions are general non-linear and critical for ANN models to simulate the transformation from input layer to output layer, which is g