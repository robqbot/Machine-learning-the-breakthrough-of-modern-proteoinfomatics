...
In the past two decades, high throughput proteomics pipeline have dominated the proteomics research skyline, with the development of oft ironasation mass spectrometry . Although the high-throughput   
\par 
