...
In the past two decades, high throughput proteomics pipeline have dominated the proteomics research skyline, with particularly the emergence of soft ironasation mass spectrometry . Although the high-throughput   
\par 
