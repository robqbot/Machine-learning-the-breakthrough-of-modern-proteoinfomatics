...
\par
Recently heated deep learning, largely due to its image pattern is a type of artificial neural network, which belongs to the realm of supervised learning. 
