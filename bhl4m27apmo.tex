...
\par
Recently heated deep learning, largely due to its superior image pattern recognition is a type of artificial neural network, which belongs to the realm of supervised learning. 
