...
Feedforward neural networks also known as multilayer perceptrons (MLPs) and arguably the most common type of models out there. The ultimate target to achieve in feedforward neural networks is to approximate a model function $\mathcal{f}(\phi)$ that 
