...
Heuristic manual approach~\cite\cite{Goodfellow-et-al-2016} was used to be dominant approach prior to modern deep learnings. The process is long and often tedious, which requires advanced domain knowledge and lack of transferrability 
\end{enumerate}
