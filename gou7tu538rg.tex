...
where $\mathcal{w}$ indicates all node weights that are affected by the regularization. The modulus $\lambda$ decides the degree of penalty on model complexity. 
\par 
