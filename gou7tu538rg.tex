...
where $\mathcal{w}$ indicates all node weights that are affected by the regularization. The modulus | \mathcal{w} | is the penalty term. $\lambda$ determines the degree of penalty for over complex neuron networks. 
\par 
