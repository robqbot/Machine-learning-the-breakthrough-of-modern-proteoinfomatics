...
where $\mathcal{w}$ indicates all node weights that are affected by the regularization. The modulus | \mathcal{w} | is the penalty term. $\lambda$ decides the degree of penalty will applied. 
\par 
