...
where $\mathcal{w}$ indicates all node weights that are affected by the regularization. The modulus | \mathcal{w} | $\lambda$ decides the degree of penalty on model complexity. 
\par 
