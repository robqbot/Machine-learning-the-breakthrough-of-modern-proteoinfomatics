...
\begin{equation}
    \nabla_{\mathcal{V}}\mathcal{z} = \sum_i (\nabla_\{\mathcal{V}}\mathcal{Y}_i)\frac{\partial\mathcal{z}}{\partial\mathcal{Y}_i} = \sum_j \sum_i (\frac{\partial{Y}_j}{\partial{V}_i)\frac{\partial\mathcal{z}}{\partial\mathcal{Y}_i}
\end{equation}
