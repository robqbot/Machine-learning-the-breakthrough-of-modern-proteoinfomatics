...
\par
One challenge in calculating gradient of the objective function $\mathcal{Obj$ is numerical evaluation is computational expensive, backprop offers an inexpensive 
\par 
