...
\par
Calculating gradient of the objective function $\mathcal{Obj}$ numerically is computational expensive, backprop computing derivatives is by propagating information through a general network 
