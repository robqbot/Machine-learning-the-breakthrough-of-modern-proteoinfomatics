...
\par
Calculating gradient of the objective function $\mathcal{Obj}$ numerically is numerical evaluation is computational expensive, backprop offers an economical solution. The computing derivatives is by propagating information through a general network 
