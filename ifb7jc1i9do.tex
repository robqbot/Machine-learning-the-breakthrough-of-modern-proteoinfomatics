...
This generalisation in deriving Jacobian is at the core of back propagation. One of demanding issue in back propagation calculations is the procedure often needs to summarise many tensors. To calculate each tensor seperately involve large expense of memory, in practise, often adopt a single buffer approach where each value is only added to the buffer after computation.